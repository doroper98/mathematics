...
function updateTrig() {
  ...
  document.getElementById('val-ta').textContent=A.toFixed(2);document.getElementById('val-tb').textContent=B.toFixed(2);document.getElementById('val-tc').textContent=C.toFixed(2);document.getElementById('val-td').textContent=D.toFixed(2);
  ...
  document.getElementById('info-amp').textContent=Math.abs(A).toFixed(2);document.getElementById('info-period').textContent=isInv?'-':(2*Math.PI/Math.abs(B)).toFixed(2);document.getElementById('info-phase').textContent=isInv?'-':(-C/B).toFixed(2);document.getElementById('info-vshift').textContent=D.toFixed(2);document.getElementById('info-trig-desc').textContent=trigDesc(trigFn);
}
